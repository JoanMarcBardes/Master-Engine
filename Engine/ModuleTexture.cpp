...
bool ModuleTexture::Init()
{
	...
	ILboolean ok = ilLoadImage("Lenna.png");
	if (ok)
	{
		ok = ilConvertImage(IL_RGB, IL_UNSIGNED_BYTE);	//Convert every colour component into unsigned byte. If your image contains alpha channel you can replace IL_RGB with IL_RGBA
		if (!ok)
		{
